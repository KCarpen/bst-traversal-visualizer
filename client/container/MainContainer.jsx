...
import { resetTraversal, bfs, preOrder, inOrder, postOrder } from '../scripts/bst-traversal.js'
...
class MainContainer extends Component {
  ...
  runInOrder(){
    const data = this.state.tree;
    const formattedData = [data.root];
    inOrder(formattedData);
  }

  runPostOrder(){
    const data = this.state.tree;
    const formattedData = [data.root];
    postOrder(formattedData);
  }
    ...
    return (
      <div id='mainContainer'>
        <div id='sideBar'>
          ...
          <div><button className='traversalBtns' onClick={() => this.runPostOrder()}> PostOrder </button></div>
